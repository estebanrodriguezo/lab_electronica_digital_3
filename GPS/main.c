...
const uint8_t LED_PIN = 16; // Cambia esto al número de pin que estás utilizando para el LED
...
{ ////////////////////uso de otro core/////////////////////
    ...
    while (1)
    {
        ...
        {
            printf("Terminal de comandos iniciada: \n");
            isCommandMode = true;
        }
        ...
        else if (strncmp(command, "FETCH", 5) == 0 && isCommandMode)
        {
